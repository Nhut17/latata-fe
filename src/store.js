...
const adminPersistConfig = {
  key: 'admin',
  storage,
  blacklist: ['successCreate','successUpdate','errorChartCol','sale_figure','successUploadBrand','successAdd','errorAdd','successAddEventBanner','successSendVoucher','useVoucherSuccessfull']
}
